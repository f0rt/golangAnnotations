...
func extractFieldList(fieldList *ast.FieldList, imports map[string]string) []intermediatemodel.Field {
	mFields := make([]intermediatemodel.Field, 0)
	if fieldList != nil {
...
func extractFields(field *ast.Field, imports map[string]string) []intermediatemodel.Field {
	mFields := make([]intermediatemodel.Field, 0)
	if field != nil {
...
func extractField(field *ast.Field, imports map[string]string) *intermediatemodel.Field {
	if fieldType := processExpression(field.Type, imports); fieldType != nil {
		return &intermediatemodel.Field{
