...
func TestStructOperationsInDir(t *testing.T) {
...

	{
		...
		assertField(t, intermediatemodel.Field{Name: "s", TypeName: "*Service"}, *o.RelatedStruct)
		...
		}
		{
			...
			assertField(t, intermediatemodel.Field{TypeName: "[]Person"}, o.OutputArgs[0])
			assertField(t, intermediatemodel.Field{TypeName: "error"}, o.OutputArgs[1])
		}
	}
	{
		...
		assertField(t, intermediatemodel.Field{Name: "uid", TypeName: "string"}, o.InputArgs[0])

		assert.Equal(t, 3, len(o.OutputArgs))
		assertField(t, intermediatemodel.Field{TypeName: "Person"}, o.OutputArgs[0])
		assertField(t, intermediatemodel.Field{TypeName: "*Person"}, o.OutputArgs[1])
		assertField(t, intermediatemodel.Field{TypeName: "error"}, o.OutputArgs[2])
	}
	{
		...
		assert.Equal(t, 1, len(o.InputArgs))
		assertField(t, intermediatemodel.Field{Name: "in", TypeName: "structs.YetAnotherStruct",
			PackageName: "github.com/MarcGrol/golangAnnotations/golangparsing/structs"}, o.InputArgs[0])

		assert.Equal(t, 2, len(o.OutputArgs))
		assertField(t, intermediatemodel.Field{TypeName: "*structs.YetAnotherStruct",
			PackageName: "github.com/MarcGrol/golangAnnotations/golangparsing/structs"}, o.OutputArgs[0])
		assertField(t, intermediatemodel.Field{TypeName: "error"}, o.OutputArgs[1])
	}
	{
