...
import (
	...
	"github.com/MarcGrol/golangAnnotations/codegeneration/eventService/eventServiceAnnotation"
...
type templateData struct {
	PackageName string
	Services    []intermediatemodel.Struct
}
...
func generate(inputDir string, structs []intermediatemodel.Struct) error {
	...
	eventServices := make([]intermediatemodel.Struct, 0)
...
func IsEventService(s intermediatemodel.Struct) bool {
...
func IsEventNotTransient(o intermediatemodel.Operation) bool {
...
func IsEventServiceNoTest(s intermediatemodel.Struct) bool {
	annotations := annotation.NewRegistry(eventServiceAnnotation.Get())
...
func GetEventServiceSelfName(s intermediatemodel.Struct) string {
	annotations := annotation.NewRegistry(eventServiceAnnotation.Get())
	if ann, ok := annotations.ResolveAnnotationByName(s.DocLines, eventServiceAnnotation.TypeEventService); ok {
...
func GetEventOperationProducesEventsAsSlice(o intermediatemodel.Operation) []string {
	annotations := annotation.NewRegistry(eventServiceAnnotation.Get())
...
func GetEventOperationProducesEvents(o intermediatemodel.Operation) string {
...
func GetEventServiceTopics(s intermediatemodel.Struct) []string {
...
func GetFullEventNames(s intermediatemodel.Struct) []string {
...
func IsEventOperation(o intermediatemodel.Operation) bool {
	annotations := annotation.NewRegistry(eventServiceAnnotation.Get())
	_, ok := annotations.ResolveAnnotationByName(o.DocLines, eventServiceAnnotation.TypeEventOperation)
	return ok
}

func GetEventOperationTopic(o intermediatemodel.Operation) string {
	annotations := annotation.NewRegistry(eventServiceAnnotation.Get())
	if ann, ok := annotations.ResolveAnnotationByName(o.DocLines, eventServiceAnnotation.TypeEventOperation); ok {
...
func GetEventOperationQueueGroups(s intermediatemodel.Struct) []queueGroup {
...
func GetEventOperationProcess(o intermediatemodel.Operation) string {
	annotations := annotation.NewRegistry(eventServiceAnnotation.Get())
	if ann, ok := annotations.ResolveAnnotationByName(o.DocLines, eventServiceAnnotation.TypeEventOperation); ok {
...
func IsAnyEventOperationDelayed(s intermediatemodel.Struct) bool {
...
func IsEventOperationDelayed(o intermediatemodel.Operation) bool {
	annotations := annotation.NewRegistry(eventServiceAnnotation.Get())
	if ann, ok := annotations.ResolveAnnotationByName(o.DocLines, eventServiceAnnotation.TypeEventOperation); ok {
...
func GetInputArgPackage(o intermediatemodel.Operation) string {
	for _, arg := range o.InputArgs {
		if !IsPrimitiveArg(arg) && !isContextArg(arg) && !isRequestContextArg(arg) {
...
func IsPrimitiveArg(f intermediatemodel.Field) bool {
