...
func GetPackageNameForStructs(structs []intermediatemodel.Struct) (string, error) {
	if len(structs) == 0 {
...
func getPackageNameForEnums(enums []intermediatemodel.Enum) (string, error) {
	if len(enums) == 0 {
...
func GetPackageNameForEnumsOrStructs(enums []intermediatemodel.Enum, structs []intermediatemodel.Struct) (string, error) {
